...
assert_equivalence(Q, DurableDeclare, AutoDeleteDeclare, Args1, Owner) ->
    ...
    rabbit_misc:assert_field_equivalence(DurableQ, DurableDeclare, QName, durable),
    rabbit_misc:assert_field_equivalence(AutoDeleteQ, AutoDeleteDeclare, QName, auto_delete),
